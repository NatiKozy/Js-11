...
function makeThree() {
	...
	h1.textContent = "Заголовок изменен!";
}
...
function makeTwelve() {
	...
	div.classList.toggle('resizable');
...
function makeTwentyTwo() {
	...
	result.textContent = `Атрибут 'src' присутствует: ${attribute}`;
}
...
function makeTwentyFive() {
	...
	const attr = div.getAttribute('data-info');
	...
	result.textContent = `Добавленный атрибут: ${attr}`
}
